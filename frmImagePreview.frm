...
Private Declare Function GPX_BitBlt Lib "GraphicalDLL" _
...
Private Sub Form_Load()
    ...
    picImage.Height = frmImage.picSave.Height
    picImage.Width = frmImage.picSave.Width
    
    GPX_BitBlt picImage.hdc, 0, 0, frmImage.picSave.ScaleWidth, frmImage.picSave.ScaleHeight, frmImage.picSave.hdc, 0, 0, vbSrcCopy, resp
    picImage.Refresh
    DoEvents
