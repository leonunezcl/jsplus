...
Begin VB.Form frmThumbs 
   ...
   Begin CCRPFolderTV6.FolderTreeview dirMain 
      ...
      Left            =   30
      TabIndex        =   10
      ToolTipText     =   "Click on folder to show contents"
      Top             =   405
      Width           =   3045
      _ExtentX        =   5371
      _ExtentY        =   6350
...
Private Sub clear_memory(frm As Form)
...
Private Sub Form_Resize()
    ...
    If Me.WindowState <> vbMinimized Then
        ...
        Else
            ...
            picSizeLeft.Move dirMain.Width + 100, 0, picSizeLeft.Width, Me.ScaleHeight - sbrMain.Height
            picFrame.Move dirMain.Width + picSizeLeft.Width + 100, 0, Me.ScaleWidth - dirMain.Width - picSizeLeft.Width - 1, Me.ScaleHeight - sbrMain.Height
...
Private Sub picSizeLeft_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Button = vbLeftButton Then
        dirMain.Width = picSizeLeft.Left + X
        Form_Resize
    End If
